...
STUDY_AREA_FORCE_NAMES: set[str] = set(STUDY_AREA_FORCE_CODES.values())

# Backwards-compat aliases
YORKSHIRE_FORCE_NAMES = STUDY_AREA_FORCE_NAMES
YORKSHIRE_FORCE_CODES = STUDY_AREA_FORCE_CODES
