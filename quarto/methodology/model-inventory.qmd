...
| Metric | Value |
|---|---|
| Pseudo-R² | 0.566 (clean full GB run; in-sample on 1:3 zero-collision downsampled training set) |
| Deviance | 821,217 |
...
| Metric | Value |
|---|---|
| Pseudo-R² | 0.325 (clean full GB run; temporal features included) |
| Test deviance | 495,172 |
...
For current project positioning, use the clean GB XGBoost pseudo-R² of `0.325`
