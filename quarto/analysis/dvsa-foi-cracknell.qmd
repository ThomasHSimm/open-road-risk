---
title: "DVSA FOI Test-Centre Findings"
subtitle: "Jake Cracknell's 2023 driving-test data as context for the DTC route analysis"
format:
  html:
    toc: true
    toc-depth: 3
...
This page summarises Jake Cracknell's 2023 DVSA FOI analysis and records how it
connects to this project's driving-test-centre work. It is background evidence,
not part of the core road-risk training pipeline: Cracknell's dataset describes
test-centre outcomes and fault categories, while this repository adds route,
road-environment, and collision-risk features around those centres.
...
## What Jake's Analysis Implies — Future Work
...
| GPS test routes | Crowdsourced GPX + Google Maps URLs | ✅ 174 routes, 24 centres (dtc/routes.py) |
