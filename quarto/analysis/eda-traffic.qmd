...
description: "Exploratory analysis of traffic volume data, AADF patterns, WebTRIS observations, exposure distributions, and model inputs."
format:
  html:
    toc: true
    toc-depth: 3
