...
description: "Diagnostic analysis of OpenStreetMap road attribute coverage, including speed limits, lanes, lighting, and surface features."
format:
  html:
    toc: true
    toc-depth: 3
...
::: {.callout-warning}
This OSM coverage diagnostic records a previous smaller-network run and has
not yet been regenerated for the current 3.94M-link full-GB rebuild. Treat the
coverage percentages below as historical until this page is rerendered from a
fresh OSM-enriched `network_features.parquet`.
:::
