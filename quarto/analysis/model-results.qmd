...
- XGBoost (pseudo-R² 0.859) substantially outperforms the GLM (pseudo-R² 0.347)
  ...
  the counted-only Stage 1a filter, the Stage 2 post-event provenance guard,
  OSM feature enrichment, IMD features, terrain grade, and the GLM
  optional-feature imputation refactor; earlier GLM pseudo-R² figures are
  prior-run snapshots, not directly comparable ablations. See
