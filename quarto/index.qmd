...
Road Risk Analysis is an open-source pipeline for estimating **exposure-adjusted collision risk** across the road network.
...
This project combines open road network, traffic, and collision datasets to estimate risk at road-link level and extend that logic to applications such as route comparison and driving test route analysis.
...
- route-level summaries for applied use cases
...
- a basis for more focused applications such as driving test route difficulty
