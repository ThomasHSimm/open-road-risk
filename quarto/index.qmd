...
description: "Open Road Risk estimates exposure-adjusted collision risk across Great Britain using open transport, road, and collision data."
...
::: {.small .text-muted}
Last updated: 2026-07-07 · Current scope: full Great Britain road-link risk outputs.
:::
...
The QGIS-ready full-GB link-level GeoPackage export is available as a public
[Kaggle Dataset](https://www.kaggle.com/datasets/thomassimm/open-road-risk-gb-link-risk-exposure-gis/).
It contains one row per OS Open Roads link with geometry, estimated exposure,
observed injury-collision summaries, and modelled risk ranking fields.
...
- **[Start here: what does a road-risk model actually predict?](what-a-road-risk-model-predicts.qmd)** — the overview argument: estimand, exposure, evaluation and limits
