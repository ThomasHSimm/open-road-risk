...
| 🟢 | Decision on long-term memory strategy — current pipeline at ~85% of 32GB ceiling, future feature additions will hit limits. Options under consideration: cloud VM as stopgap, sample-for-training, out-of-core (Polars/Dask), region split. None solves the fundamental link-year cross-product cost. |
